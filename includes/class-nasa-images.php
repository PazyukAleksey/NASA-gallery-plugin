...
class Nasa_Images {
    ...
    protected $tomorrow_date;
    protected $today_date;
    protected $nasa_api_day_url;
    protected $nasa_api_day_data;
    ...
    public function get_nasa_api_day_data() {
        return $this->nasa_api_day_data;
    }
    ...
    public function get_nasa_api_day_url() {
        return $this->nasa_api_day_url;
    }
